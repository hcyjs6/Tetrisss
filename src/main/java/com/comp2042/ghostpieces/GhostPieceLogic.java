...
public final class GhostPieceLogic {
    ...
    public static ViewData createGhostPieceViewData(int[][] currentShape, Point currentOffset, int ghostPieceY, int[][] nextBrickData) {
        return new ViewData(currentShape, (int) currentOffset.getX(), ghostPieceY, nextBrickData);
    }
}
